 ...
 <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">                            
                        <a href="{{route('index')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="profile" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('profile-page')}}">View Profile </a>
                            </li>
                            <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="category" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('create-category')}}">Create Ad Category </a>
                            </li>
                            <li>
                                <a href="{{route('list-category')}}">View All Categories </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="#cv-category" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled" id="cv-category" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('create-cv-category')}}">Create Cv Category </a>
                            </li>
                            <li>
                                <a href="{{route('list-cv-category')}}">View All Categories </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        <a href="#cv" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="#boosted_cv" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-cpu"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"></rect><rect x="9" y="9" width="6" height="6"></rect><line x1="9" y1="1" x2="9" y2="4"></line><line x1="15" y1="1" x2="15" y2="4"></line><line x1="9" y1="20" x2="9" y2="23"></line><line x1="15" y1="20" x2="15" y2="23"></line><line x1="20" y1="9" x2="23" y2="9"></line><line x1="20" y1="14" x2="23" y2="14"></line><line x1="1" y1="9" x2="4" y2="9"></line><line x1="1" y1="14" x2="4" y2="14"></line></svg>
                                <span>Boosted Cvs</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled" id="boosted_cv" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('create-boost-cvs')}}"> Add Boosted Cvs </a>
                            </li>
                            <li>
                                <a href="{{route('all-boost-cvs')}}"> View All cvs </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="transactions" data-parent="#accordionExample">
                            <li>
                                <a href="{{ route('product-transactions') }}"> View Product Transactions</a>
                            </li>
                            <li>
                                <a href="{{ route('cv-transactions') }}"> View Cv Transactions</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{ route('admin-list') }}"> View Admins </a>
                            </li>
                            <li>
                                <a href="{{ route('user-list') }}"> View Users </a>
                            </li>
                            @else
                            <li>
                                <a href="{{ route('user-list') }}"> View Users </a>
                    ...
                    @if (auth()->user()->user_type == 'super_admin')
                    <li class="menu">
                        <a href="{{route('app-settings')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
