           ...
           <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($user as $k => $each_user)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('ad-details', $each_user->unique_id)}}" target="_blank" title="View" class="btn btn-primary">View User</a>
                                                </td>
                                            </tr>
                                            @php $count++ @endphp
                                        @endforeach
                    ...
                    <div style="position: fixed; bottom: 30px; right: 30px; z-index: 200">
                        <button type="button" class="btn btn-primary" id="deleteAdmin" title="Select User(s) to be deleted by ticking the checkbox on each row and then click this button to proceed">Delete User(s)</button>
                    </div>
                </div>
