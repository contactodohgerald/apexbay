                    ...
                    <div class="account-content">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form id="work-experience" class="section work-experience" action="{{route('add-boost-cvs')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="info">
                                        ...
                                        <div class="work-section container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="add_banner">Cv Image / Banner</label>
