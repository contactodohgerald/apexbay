...
Template Name: Apexbay – ICO, Cryptocurrency Website & ICO Landing Page HTML + Dashboard Template
Version      : 1.6
===================================*/
...
$(document).ready( function() {
	$(window).on("load", function() {
		$('body').prepend('<a href="https://www.designnominees.com/themes/Apexbay-ico-cryptocurrency-ico-landing-page-html-template" title="Design Nominees" style="width:70px;height:130px;position:fixed;top:100px;right:0px;z-index:99999;text-indent:-9999px;background: url(https://www.designnominees.com/ribbons/designnominees-ribbon-blue-right.png) no-repeat;" target="_blank">Design Nominees</a> <a href="https://www.bestcss.in/user/detail/ApexbayICOCryptocurrencyLandingPageHTML5Template-9139" style="width:106px;height:92px;position:fixed;top:0px;right:0px;z-index:99999;text-indent:-9999px;background: url(https://www.bestcss.in/ribbons/black-right.png) no-repeat;" target="_blank">Best CSS Web Gallery</a>');
	});
});
